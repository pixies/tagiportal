...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { artigo_id: @comentario.artigo_id, body: @comentario.body, comentario: @comentario.comentario }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { artigo_id: @comentario.artigo_id, body: @comentario.body, comentario: @comentario.comentario }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
